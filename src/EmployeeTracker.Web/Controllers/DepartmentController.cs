...
using EmployeeTracker.Application.Features.Departments.CreateDepartment;
using EmployeeTracker.Application.Features.Departments.DeleteDepartment;
using EmployeeTracker.Application.Features.Departments.GetDepartment;
using EmployeeTracker.Application.Features.Departments.GetDepartmentEmployees;
using EmployeeTracker.Application.Features.Departments.GetDepartments;
using EmployeeTracker.Application.Features.Departments.UpdateDepartment;
using MediatR;
