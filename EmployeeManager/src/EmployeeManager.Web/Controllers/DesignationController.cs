...
using EmployeeManager.Application.Features.Designations.CreateDesignation;
using EmployeeManager.Application.Features.Designations.DeleteDesignation;
using EmployeeManager.Application.Features.Designations.GetDesignation;
using EmployeeManager.Application.Features.Designations.GetDesignationEmployees;
using EmployeeManager.Application.Features.Designations.GetDesignations;
using EmployeeManager.Application.Features.Designations.UpdateDesignation;
using MediatR;
